    ...
    <section className="py-20 gradient-gold relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a
            href="#contact"
            className="bg-navy text-primary-foreground px-8 py-4 rounded-md font-heading font-bold text-sm uppercase tracking-wider hover:bg-navy-deep transition-colors flex items-center gap-2"
          >
            Contact Us
          ...
          <a
            ...
            className="border-2 border-secondary-foreground/30 text-secondary-foreground px-8 py-4 rounded-md font-heading font-bold text-sm uppercase tracking-wider hover:border-secondary-foreground transition-colors flex items-center gap-2"
          >
